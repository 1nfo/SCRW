...
STARTID = 1
ENDID = 4400000  # each retrieves 4.4 M and ENDID must be divisible by 1000
NO_TOKEN = 1  # typically 2 or 3 can make sure no idle time

# ====No Toughing====#
DEF_FILE_SIZE = 1000
MAXID = 17210209  # 7PM 02/12/2016
DEF_PAGE = 100
